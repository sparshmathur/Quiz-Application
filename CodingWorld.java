...
public class CodingWorld extends JFrame implements ActionListener {


    JButton b1, b2;
    JTextField t1;
    CodingWorld(){
        setBounds(400, 200, 1200, 500  );//dleft, //dup, //dlen, dheight
        getContentPane().setBackground(Color.WHITE);
        setLayout(null);

       ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("practice/login.jpeg"));
       JLabel l1 = new JLabel(i1);
       l1.setBounds(0,0,600,500);
       add(l1);

       JLabel l2 = new JLabel("Coding World");
